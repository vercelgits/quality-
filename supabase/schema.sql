...
-- Au plus cinq liens, et chacun doit etre une paire libelle + adresse. La
-- contrainte vit en base parce qu'un client peut toujours etre contourne.
alter table public.profiles
    ...
    and not exists (
      select 1
       ...
       where jsonb_typeof(entry) <> 'object'
          ...
          -- Seuls http et https : un lien `javascript:` deviendrait une faille
          -- des qu'il serait rendu cliquable.
          or entry->>'url' !~ '^https?://'
    )
  );
